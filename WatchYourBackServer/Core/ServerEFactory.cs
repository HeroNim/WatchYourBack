...
namespace WatchYourBackServer
{
     ...
     */
    public static class ServerEFactory
    {
        
        public static Entity createAvatar(Rectangle rect, Allegiance player, Weapons weaponType)
        {
        ...
        public static Entity createSword(Entity wielder, Allegiance wielderAllegiance, float xOrigin, float yOrigin, float rotationAngle, VelocityComponent anchorMovement)
        {
            return new Entity(
        ...
        public static Entity createThrown(Allegiance wielderAllegiance, float xOrigin, float yOrigin, Vector2 rotationVector)
        {
        ...
        public static Entity createButton(int x, int y, int width, int height, Inputs type)
        {
